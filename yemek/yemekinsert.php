...
<div class="container-fluid bg-3 text-center">    
  <h3>Menu managment page</h3>
  <a href="yemekindex.php" class="btn btn-primary pull-right" style='margin-top:-30px'><span class="glyphicon glyphicon-eye-open"></span> View Menu</a>
  <br>
        ...
        <div class="panel-heading">Please Fill All The Required Fields To Add a Customer</div>
            ...
            <div class="panel-body">
             ...
             <div class="form-group">
               ...
               <div class="col-sm-5">
                  <input class="form-control" type="number" name="calori" required>
               </div>
            </div>
            <div class="form-group">
