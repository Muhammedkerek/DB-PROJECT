...
<div class="container-fluid bg-3 text-center">    
  <h3>Updating the Employee Info</h3>
        ...
        <div class="panel-heading">You can update it all from here</div>
            ...
            <div class="panel-body">             
             <div class="form-group">
               ...
               <div class="col-sm-5">
                  <input class="form-control" value= "<?=$user->hours?>"type="number" name="hours" required>
               </div>
            </div>
             <div class="form-group">
               <label class="control-label col-sm-2">Experience:<span style='color:red'>*</span></label>
               <div class="col-sm-5">
                  <input class="form-control" value= "<?=$user->experience?>"type="text" name="experience" required>
               </div>
            </div>            
             <div class="form-group">
               <label class="control-label col-sm-2">Birthdate<span style='color:red'>*</span></label>
               <div class="col-sm-5">
                  <input class="form-control" value= "<?=$user->birthdate?>"type="date" name="birthdate" required>
               </div>
            </div>
            <div class="form-group">
