...
<div class="container-fluid bg-3 text-center">    
  <h3>VIP managment page</h3>
  <a href="index.php" class="btn btn-primary pull-right" style='margin-top:-30px'><span class="glyphicon glyphicon-eye-open"></span> View VIP properties</a>
  <br>
  
  <div class="panel panel-primary">
        <div class="panel-heading">Please Fill All The Required Fields To Add a VIP Customer</div>
            ...
            <div class="panel-body">
             ...
             <div class="form-group">
               ...
               <div class="col-sm-5">
                  <input class="form-control" type="number" name="tc" required>
               </div>
            </div>
            <div class="form-group">
