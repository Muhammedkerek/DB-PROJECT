...
<div class="container-fluid bg-3 text-center">    
  <h3>Customer managment page</h3>
  <a href="index.php" class="btn btn-primary pull-right" style='margin-top:-30px'><span class="glyphicon glyphicon-eye-open"></span> View Customers</a>
  <br>
